...
cons_BB_TE2_model = lm(Y_out_BB ~ ., data = esc_BB)
...
cons_GRASP_TE2_model = lm(Y_out_GRASP ~ ., data = esc_GRASP)
...
c(mean(Y-GRASP_PWO_pred)^2,mean(Y-GRASP_TE_pred)^2,mean(Y-GRASP_TE2_pred)^2,mean(Y-GRASP_CP_pred)^2,mean(Y-BB_GRASP_pred)^2)
